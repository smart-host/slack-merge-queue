...
export declare abstract class Methods extends EventEmitter<WebClientEvent> {
    ...
    readonly admin: {
        ...
        barriers: {
            create: Method<AdminBarriersCreateArguments, WebAPICallResult>;
            delete: Method<AdminBarriersDeleteArguments, WebAPICallResult>;
            list: Method<AdminBarriersListArguments, WebAPICallResult>;
            update: Method<AdminBarriersUpdateArguments, WebAPICallResult>;
        };
        conversations: {
            archive: Method<AdminConversationsArchiveArguments, WebAPICallResult>;
            convertToPrivate: Method<AdminConversationsConvertToPrivateArguments, WebAPICallResult>;
            create: Method<AdminConversationsCreateArguments, WebAPICallResult>;
            delete: Method<AdminConversationsDeleteArguments, WebAPICallResult>;
            disconnectShared: Method<AdminConversationsDisconnectSharedArguments, WebAPICallResult>;
            ekm: {
                listOriginalConnectedChannelInfo: Method<AdminConversationsEKMListOriginalConnectedChannelInfoArguments, WebAPICallResult>;
            };
            getConversationPrefs: Method<AdminConversationsGetConversationPrefsArguments, WebAPICallResult>;
            getTeams: Method<AdminConversationsGetTeamsArguments, WebAPICallResult>;
            invite: Method<AdminConversationsInviteArguments, WebAPICallResult>;
            rename: Method<AdminConversationsRenameArguments, WebAPICallResult>;
            restrictAccess: {
            ...
            search: Method<AdminConversationsSearchArguments, WebAPICallResult>;
            setConversationPrefs: Method<AdminConversationsSetConversationPrefsArguments, WebAPICallResult>;
            setTeams: Method<AdminConversationsSetTeamsArguments, WebAPICallResult>;
            unarchive: Method<AdminConversationsUnarchiveArguments, WebAPICallResult>;
        };
        emoji: {
            add: Method<AdminEmojiAddArguments, WebAPICallResult>;
            addAlias: Method<AdminEmojiAddAliasArguments, WebAPICallResult>;
            list: Method<AdminEmojiListArguments, WebAPICallResult>;
            remove: Method<AdminEmojiRemoveArguments, WebAPICallResult>;
            rename: Method<AdminEmojiRenameArguments, WebAPICallResult>;
        };
        inviteRequests: {
        ...
        teams: {
            ...
            settings: {
                ...
                setIcon: Method<AdminTeamsSettingsSetIconArguments, WebAPICallResult>;
        ...
        users: {
            ...
            session: {
                ...
                invalidate: Method<AdminUsersSessionInvalidateArguments, WebAPICallResult>;
            };
    ...
    readonly apps: {
        connections: {
            open: Method<AppsConnectionsOpenArguments, WebAPICallResult>;
        };
        event: {
            authorizations: {
                list: Method<AppsEventAuthorizationsListArguments, WebAPICallResult>;
            };
        };
        uninstall: Method<AppsUninstallArguments, WebAPICallResult>;
    };
    readonly auth: {
        revoke: Method<AuthRevokeArguments, WebAPICallResult>;
        teams: {
            list: Method<AuthTeamsListArguments, WebAPICallResult>;
        };
